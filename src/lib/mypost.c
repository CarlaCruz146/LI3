...
/**
  *@brief   Função que dará cast ao void, tornando-o num array dinâmico e depois dará free a essa estrutura.
...
/**
*@brief   Função que dará init a um post, retornando o mesmo.
*/
Post initPost(){
...
/**
  ...
  *@param   Recebe um id, o type, o parent id, o score, o viewcount, a data de criação, o criador, o número de comentário e o titulo.
*/
